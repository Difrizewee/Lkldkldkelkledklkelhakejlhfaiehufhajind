    ...
    <>
      <header
        className={[
          ...
          scrolled ? "bg-background/95 backdrop-blur-[12px] border-b border-ok-border" : "bg-transparent",
        ].join(" ")}
      >
        <div className="ok-container">
          <div className="flex h-[72px] items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6 text-[13px] text-ok-muted">
              ...
              <a
                href="#contact"
                className="ml-2 inline-flex h-10 items-center justify-center rounded-[4px] border border-ok-border px-4 text-foreground transition-colors hover:border-ok-lime hover:text-ok-lime"
              >
                Получить бриф
              </a>
            </nav>
            ...
            <a
              href="#contact"
              className="hidden sm:inline-flex md:hidden h-10 items-center justify-center rounded-[4px] border border-ok-border px-4 text-[12px] font-mono uppercase tracking-wider text-foreground"
              onClick={() => setOpen(false)}
            >
              Получить бриф
            </a>
